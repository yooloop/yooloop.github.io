...
let items = []
let page = 1
let Url = 'https://kkapi-open-1394400914-qqcom.vercel.app/api/ispeak?author=6411817e886e47542d99a4ed&page=' // 记住替换为你的API链接
...
function contentFormat(s) {
    ...
    if (ls) {
        ls.forEach((e) => {
            html += '<a href="' + e + '" target="_blank" data-fancybox="group" class="fancybox"></a>'
        })
    }
    s += html
    return s
